...
app.post('/logistics_apply.html', upload.single('fafa'), function (req, res) {
  ...
  var mailOptions = {
    ...
    // plain text body
    html: "<h3> New Application from ".concat(lname, " ").concat(fname, "</h3> <br> <p>Email : ").concat(email, "</p> <br> <p>Phone number: ").concat(phone, "</p> <br> <p>File path: ").concat(req.file.path, "</p><br> <p>CV is located <a href='www.troydreamville.com/").concat(req.file.path, "'>here</a></p><br> <p>Message : ").concat(oinfo, "</p> <br> <h4 style='font-style:italic;font-weight:400;'>This was sent from our company's microsoft account.</h4>")
  };
  transporter.sendMail(mailOptions, function (error, info) {
    if (error) {
      console.log(error);
